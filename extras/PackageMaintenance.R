...
OhdsiRTools::checkUsagePackage("adultASSUREv6")
OhdsiRTools::updateCopyrightYearFolder()
install.packages("devtools")
devtools::spell_check()

# Create manual -----------------------------------------------------------
unlink("extras/adultASSUREv6.pdf")
shell("R CMD Rd2pdf ./ --output=extras/adultASSUREv6.pdf")
...
OhdsiRTools::createRenvLockFile(rootPackage = "adultASSUREv6",
                                mode = "description",
